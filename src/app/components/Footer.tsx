const Footer = () => {
	return (
		<footer className="bg-blue-500 text-center text-surface/75 dark:bg-gradient-to-r from-black to-slate-700 dark:text-white/75 lg:text-left">
			<div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-white/10 lg:justify-between">
				<div className="me-12 hidden lg:block">
					<span>Terhubung dengan media sosial kami:</span>
				</div>
			...
			<div className="mx-6 py-10 text-center md:text-left">
				<div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
					...
					<div>
						...
						<p className="mb-4">
							<a href="#!">Belajar di PIJAR</a>
						</p>
						<p className="mb-4">
							<a href="#!">Jadi Mentor di PIJAR</a>
						</p>
						<p>
							<a href="#!">Bantuan</a>
						</p>
